<template>
  <div :class="classes">
    ...
    <TheSearch />
    <BaseTooltip text="Голосовой поиск" :left="isSmallScreen">
    ...
    computed: {
      classes () {
        return this.isSmallScreen
          ...
          : [ 'hidden', 'sm:flex', 'items-center', 'justify-end', 'p-2.5', 'pl-8', 
              'md:pl-12', 'md:px-8', 'flex-1', 'lg:px-0', 'lg:w-1/2', 'max-w-screen-md' ]
      }
    },
