...
<script>
  export default {
    ...
    data () {
      return {
        isShown: false //переменная состояния
      }
    },
    ...
    computed: {
      classes () {
        return [
          'bg-gray-600', 'bg-opacity-80', 'rounded-sm', 'text-white', 'text-xs', 'whitespace-nowrap', 
          'p-2', 'transform', 'absolute', ...this.getPositionClasses()
        ]
      }
    },
