			...
			<div class="container">
				<div class="row align-items-center mt-4 mt-md-5">
					...
					<div class="col-12 col-md-3">
						<div class="alert alert-default px-0 mb-0 py-1 py-md-3">
							<!-- Геттер 'cart/length' обращается к геттеру length в модуле Vuex с именем 'cart' -->
							<div class="text-nowrap">В корзине: {{ $store.getters['cart/length'] }} шт</div>
							<div class="text-nowrap">Общая сумма: {{ $store.getters['cart/total'] }} ₽</div>
						</div>
					</div>
				</div>
				<hr>
