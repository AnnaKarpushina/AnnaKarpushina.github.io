...
export default {
	...
	actions: {
		...
		// Вызываем мутацию "setOrderPlaced", она изменяет состояние приложения, устанавливая значение переменной "orderPlaced" равным value
		updateOrderPlaced({ commit }, value) {
