  ...
  export default {
    ...
    async created() {
      try {
        ...
        this.post = response.data // содержит данные о посте, полученные из API
      } catch (error) {
    ...
    methods: {
      goBack() {
        ...
        // Если же мы находимся на любой другой странице, то при нажатии на кнопку назад мы вернемся на предыдущую страницу
